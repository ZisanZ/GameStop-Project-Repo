...
<div class="first">
    ...
    <center>
        <font color="#1B6392" face="times new roman" size="12">List Of Banned Customers</font><br>
        ...
        <?php 
            ...
            <tr>
                ...
                while($w=mysqli_fetch_assoc($result)){
                    ...
                    $username=$w['username'];
                    $email=$w['email'];  
                    echo"<tr><td><font color=\"black\" face=\"times new roman\" size=\"5\">$name</font></td>
                    ...
                    <td><a href=\"../Controllers/recover-customer.php?id={$userid}\"><font color=\"5799EF\" face=\"times new roman\" size=\"5\">Recover Customer</font></a></td>          
                    </tr>";
                }
            }else{
                echo"<tr><br><br><br><td align=\"center\"><font color=\"black\" face=\"times new roman\" size=\"6\">No Banned Customer Found</font></td><br><br><br></tr>";
            }
        ?>
        </table>
