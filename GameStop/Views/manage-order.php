...
<div class="first">
    ...
    <div class="header"></div><br><br><br><br>
    <center>
        <font color="#1B6392" face="times new roman" size="12">Manage Order</font><br>
        <hr color="#1B6392" width="530px"><br><br>
        
        <table width="60%" border="0" cellspacing="0" cellpadding="10">
            <tr align="center">
                <td>
                    <a href="view-all-pending-order.php"><font color="black" face="times new roman" size="6">View All Pending Order</font></a>
                </td>
            </tr>
            <tr align="center">
                <td>
                    <a href="view-all-rejected-order.php"><font color="black" face="times new roman" size="6">View All Rejected Order</font></a>
                </td>
            </tr>
        </table>
    </center>
