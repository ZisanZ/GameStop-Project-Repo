...
<body>
    ...
    <center>
        <font color="#1B6392" face="times new roman" size="7">Edit Product Info</font><br><br>
        <hr color="#1B6392" width="530px"><br><br>
        <center>
                
            <img src=<?php echo "../{$result['productpic']}" ?> width="170px">
                
        </center><br>
        <form action="../Controllers/update-product-controller.php" method="POST" enctype="multipart/form-data">
            <table width="60%" border="0" cellspacing="0" cellpadding="10">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" size="60px" name="title" id="title" value="<?php echo"{$result['productname']}" ?>" onkeyup="validateTitle()">
                        <br>
                ...
                <tr>
                    ...
                    <td>
                        <textarea cols="57" rows="7" name="description" id="description"  onkeyup="validateDescription()"><?php echo"{$result['productdescription']}" ?></textarea>
                        <br>
                ...
                <tr>
                    ...
                    <td>
                        <select name="category" id="category" value="<?php echo"{$result['productcategory']}" ?>" onchange="validateCategory()">
                            <option value="" selected>Select Product Category</option>
                            <option value="Gamepad" <?php if($result['productcategory']=='Gamepad') echo 'selected' ?>>Gamepad</option>
                            <option value="Gaming Chair" <?php if($result['productcategory']=='Gaming Chair') echo 'selected' ?>>Gaming Chair</option>
                            <option value="Keyboard" <?php if($result['productcategory']=='Keyboard') echo 'selected' ?>>Keyboard</option>
                            <option value="Mouse" <?php if($result['productcategory']=='Mouse') echo 'selected' ?>>Mouse</option>
                            <option value="Mouse Pad" <?php if($result['productcategory']=='Mouse Pad') echo 'selected' ?>>Mouse Pad</option>
                        </select>
                        <br>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" size="60px" name="price" id="price" value="<?php echo"{$result['productprice']}" ?>" onkeyup="validatePrice()">
                        <br>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" size="60px" name="quantity" id="quantity" value="<?php echo"{$result['productquantity']}" ?>" onkeyup="validateQuantity()">
                        <br>
                ...
                <tr align="center">
                    <td colspan="2">
                        <br>
                        <input class="btn-submit" type="submit" id="submitButton" name="Update" value="Update">
                    </td>
                </tr>
            </table><br>
        </form>
    ...
    <script>
        ...
        function validateTitle() {
            ...
            if (!isNotEmpty(titleInput.value) || titleInput.value.length > 50) {
                titleError.textContent = "Title must not be empty and should be 50 characters or less.";
            } else {
