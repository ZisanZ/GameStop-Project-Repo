...
<div class="first">
    ...
    <center>
        <font color="#1B6392" face="times new roman" size="12">Product Info</font><br><br>
        ...
        <?php 
            ...
            <tr>
                ...
                while($w=mysqli_fetch_assoc($result)){
                    ...
                    <td><a href=\"../Controllers/delete-product-controller.php?pid={$pid}\"><font id=\"id\" color=\"5799EF\" face=\"times new roman\" size=\"5\">Delete Product</font></a></td>          
                    </tr>";
                }
            }else{
