...
<div class="first">
    ...
    <center>
        <font color="#1B6392" face="times new roman" size="12">Pending Order</font><br><br>
        ...
        <?php 
            ...
            <tr>
                ...
                <td>
                    <font color=\"#1B6392\" face=\"times new roman\" size=\"5\">Avaiable Quantity</font>
                ...
                <td>
                    <font color=\"#1B6392\" face=\"times new roman\" size=\"5\">Confirm</font>
                    <hr color=\"#1B6392\" width=\"100px\" align=\"left\">
                </td>
                <td>
                    <font color=\"#1B6392\" face=\"times new roman\" size=\"5\">Reject</font>
                    <hr color=\"#1B6392\" width=\"100px\" align=\"left\">
                </td>
            </tr>";
                while($w=mysqli_fetch_assoc($result)){
                    ...
                    <td><font id=\"productprice\" color=\"black\" face=\"times new roman\" size=\"5\">$purchaseprice</font></td>
                    ...
                    <td><a href=\"../Controllers/confirm-order-controller.php?pid={$pid}&oid={$orderid}\"><font id=\"id\" color=\"5799EF\" face=\"times new roman\" size=\"5\">Confirm</font></a></td>   
                    <td><a href=\"../Controllers/reject-order-controller.php?pid={$pid}&oid={$orderid}\"><font id=\"id\" color=\"5799EF\" face=\"times new roman\" size=\"5\">Reject</font></a></td>       
                    </tr>";
                }
            }else{
