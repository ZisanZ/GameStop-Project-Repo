...
<div class="first">
    ...
    <center>
        <font color="#1B6392" face="times new roman" size="12">List Of Banned Product</font><br><br><br>
        ...
        <?php 
            ...
            <tr>
                ...
                <td>
                    <font color=\"#1B6392\" face=\"times new roman\" size=\"5\">Status</font>
                    <hr color=\"#1B6392\" width=\"80px\" align=\"left\">
                </td>
                <td>
                ...
                while($w=mysqli_fetch_assoc($result)){
                    $proudctid=$w['productid'];
                    $productname=$w['productname'];
                    $productcategory=$w['productcategory'];
                    $productstatus=$w['productstatus'];  
                    echo"<tr><td><font color=\"black\" face=\"times new roman\" size=\"5\">$proudctid</font></td>
                    <td><font color=\"black\" face=\"times new roman\" size=\"5\">$productname</font></td>
                    <td><font color=\"black\" face=\"times new roman\" size=\"5\">$productcategory</font></td> 
                    <td><a href=\"../Controllers/recover-product-controller.php?pid={$proudctid}\"><font color=\"5799EF\" face=\"times new roman\" size=\"5\">Recover Customer</font></a></td>          
                    </tr>";
                }
            }else{
                echo"<tr><br><br><br><td align=\"center\"><font color=\"black\" face=\"times new roman\" size=\"6\">No Banned Product Found</font></td><br><br><br></tr>";
            }
        ?>
        </table>
        <br><br><br><br>
