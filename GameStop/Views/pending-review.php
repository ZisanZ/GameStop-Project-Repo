...
<div class="first">
    ...
    <center>
        <font color="#1B6392" face="times new roman" size="12">Pending Review</font><br><br>
        ...
        <?php 
            ...
            <tr>
                ...
                <td>
                    <font color=\"#1B6392\" face=\"times new roman\" size=\"5\">Approve</font>
                ...
                while($w=mysqli_fetch_assoc($result)){
                    ...
                    <td><a href=\"../Controllers/approve-review-controller.php?reviewid={$reviewid}\"><font color=\"5799EF\" face=\"times new roman\" size=\"5\">Approve Review</font></a></td>  
                    <td><a href=\"../Controllers/reject-review-controller.php?reviewid={$reviewid}\"><font color=\"5799EF\" face=\"times new roman\" size=\"5\">Reject Review</font></a></td>        
                    </tr>";
                }
            }else{
                echo"<tr><br><br><br><td align=\"center\"><font color=\"black\" face=\"times new roman\" size=\"6\">No Pending Review Found</font></td><br><br><br></tr>";
            }
        ?>
        </table>
        <br><br><br>
