...
<div class="first">
    ...
    <center>
        <font color="#1B6392" face="times new roman" size="12">Sales Report</font><br><br>
        ...
        <?php 
            ...
            <tr>
                ...
                $count=0;
            while($count<1){
                echo" <tr><td></td><td></td><td><button class=\"btn-submit\" onclick=\"window.print()\">Print Purchase History</td></tr>";
                $count++;
                }
            }
        ?>
