...
<div class="first">
    ...
    <center>
        <font color="#1B6392" face="times new roman" size="12">Update Inventory</font><br><br>
        ...
        <?php 
            ...
            <tr>
                ...
                while($w=mysqli_fetch_assoc($result)){
                    ...
                    <td><a href=\"update-product-inventory-info.php?pid={$pid}\"><font id=\"id\" color=\"5799EF\" face=\"times new roman\" size=\"5\">Update Product Inventory</font></a></td>          
                    </tr>";
                }
            }else{
