...
<div class="first">
    ...
    <center>
        <font color="#1B6392" face="times new roman" size="10">Keyboard</font><br><br><br>
        ...
        <table width="40%" border="0" cellspacing="0" cellpadding="15">
                        <?php
                                if(mysqli_num_rows($result)>0){
                                    ...
                                    echo"<tr><td align=\"center\"><font color=\"black\" face=\"times new roman\" size=\"6\">No Keyboard Found</font></td></tr>";
                                }
                                ?>
                </table><br><br><br>
    </center>
