...
<body>
    ...
    <center>
        <font color="#1B6392" face="times new roman" size="12">Settings</font><br><br><br>
        <hr color="#1B6392" width="530px"><br><br><br>

        <table width="60%" border="0" cellspacing="0" cellpadding="10">
            <tr align="center">
                <td>
                    <a href="change-password.php"><font color="black" face="times new roman" size="6">Change Password</font></a>
                </td>
            </tr>
            <tr align="center">
                <td>
