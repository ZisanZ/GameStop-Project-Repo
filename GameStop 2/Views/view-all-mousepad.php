<?php
    ...
    $isSignedIn = isset($_COOKIE['id']);
    $id = $isSignedIn ? $_COOKIE['id'] : null;
    $row = $isSignedIn ? UserInfo($id) : null;

    $result = getAllMousepad();
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>View All Mouse Pad</title>
...
<div class="first">
    ...
    <?php if ($isSignedIn && $row['role'] == "Business Client"): ?>
...
<center>
    <font color="#1B6392" face="times new roman" size="10">Mouse Pad</font><br><br><br>
    ...
    <table width="40%" border="0" cellspacing="0" cellpadding="15">
        <?php
            if (mysqli_num_rows($result) > 0) {
                ...
                echo "<tr><td align=\"center\"><font color=\"black\" face=\"times new roman\" size=\"6\">No Mouse Pad Found</font></td></tr>";
            }
        ?>
    </table><br><br><br>
</center>
...
<div class="footer">
    <center>
        ...
        <a href="terms-and-services.php"><font color="white" face="times new roman" size="4">Terms and Services</font></a><br><br>
